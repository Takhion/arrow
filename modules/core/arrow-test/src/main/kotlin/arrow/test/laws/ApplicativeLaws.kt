...
object ApplicativeLaws {
  ...
  inline fun <F: KindType> laws(A: Applicative<F>, EQ: Eq<Kind<F, Int>>): List<Law> =
  ...
  fun <F: KindType> Applicative<F>.mapDerived(EQ: Eq<Kind<F, Int>>): Unit =
  ...
  fun <F: KindType> Applicative<F>.cartesianBuilderMap(EQ: Eq<Kind<F, Int>>): Unit =
  ...
  fun <F: KindType> Applicative<F>.cartesianBuilderTupled(EQ: Eq<Kind<F, Int>>): Unit =
    forAll(genIntSmall(), genIntSmall(), genIntSmall(), genIntSmall(), genIntSmall(), genIntSmall(), { a: Int, b: Int, c: Int, d: Int, e: Int, f: Int ->
